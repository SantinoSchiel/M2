...
const changeName = document.querySelector("#createdBy");
changeName.innerHTML = "Aplicación creada por: Santino";
...
//  5) Al final de este archivo, antes de la línea que dice "NO CAMBIES NADA DE ACÁ PARA ABAJO" escribe una línea para hacer el llamado a esta funcion (displayToDos)
...
function addToDo() {
  ...
  if (inputValue !== ""){
    var addValue = new ToDo(inputValue);
    toDoItems.push(addValue);
...
// Todo Event Listener recibe como parámetro el objeto 'event' conteniendo un montón de información que incluye el tipo del evento, que elemento fue el que lo llamó, los valores de dicho elemento, etc.
//todo En este paso vamos a utilizarlo para encontrar el index del item que disparó el evento (Esta parte ya se encuentra desarrollada pero está comentada dentro de la función por lo que va a ser necesario que la descomenten)]
...
var reset = document.getElementById("addButtonReset")
